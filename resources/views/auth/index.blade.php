...
@section('content')
    <x-forms.auth-forms title="Вход в аккаунт" action="{{ route('auth.sign-in') }}" method="POST">
        @csrf
        ...
        <x-slot:buttons>
            <div class="space-y-3 mt-5">
                ...
                <div class="text-xxs md:text-xs"><a href="{{ route('auth.sign-up') }}" class="text-white hover:text-white/70 font-bold">Регистрация</a></div>
            </div>
        </x-slot:buttons>
    </x-forms.auth-forms>
@endsection
